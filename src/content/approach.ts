export const APPROACH = {
  framing:
    "Like the first light of a new day, every customer journey begins with discovery. Strategic marketing nurtures that journey into trust, action and lasting loyalty.",
  stages: [
    {
      title: "Attract",
      subtitle: "Helping people discover your business",
      description:
        "This stage is about increasing visibility and putting your brand in front of the right audience. Whether through social media, content marketing, paid ads, or PR, I'll help you get noticed by the people who matter most to your business.",
    },
    {
      title: "Engage",
    ...
    {
      title: "Retain",
      subtitle: "Keeping customers engaged",
      description:
        "Great marketing doesn't stop after the first sale. This stage focuses on building loyalty and encouraging repeat business through thoughtful follow-up, email nurture, exclusive offers, and ongoing value that keeps your brand top of mind.",
    },
    {
      title: "Advocate",
